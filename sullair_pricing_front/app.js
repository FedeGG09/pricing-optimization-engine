...
function updateActionButtonsState() {
  ...
  const enabled = hasAccount && hasProduct;

  el("recommendBtn").disabled = !enabled;
  el("btnExplainAi").disabled = !enabled;
  el("btnAnomalies").disabled = !enabled;
  el("btnStrategy").disabled = !enabled;
  el("btnWhatIf").disabled = !enabled;
}
...
async function requestExplainAI() {
  ...
  try {
    ...
    const data = await fetchJSON(`${API_BASE}/agents/explain-pricing`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    });
...
async function requestAnomalies() {
  ...
  try {
    ...
    const data = await fetchJSON(`${API_BASE}/agents/detect-anomalies`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    });
...
async function requestStrategy() {
  ...
  try {
    ...
    const data = await fetchJSON(`${API_BASE}/agents/recommend-strategy`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    });
...
async function requestWhatIf() {
  ...
  try {
    ...
    const data = await fetchJSON(`${API_BASE}/agents/what-if-simulation`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        ...payload,
...
async function sendNarratorChat() {
  ...
  try {
    ...
    const data = await fetchJSON(`${API_BASE}/agents/narrator-chat`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    });
